Este é um projeto acadêmico para criação de um podcast gerado por IA. Para que isto fosse possível foram usados diferentes prompts para geração de título, imagem e texto do episódio do podcast. Seguem os prompts utilizados.
...
Geração de imagem:
  ...
  Crie um desenho em 32 bits de um astronauta podcaster com headphones e um microfone de estúdio para podcast

Geração de texto do episódio:
